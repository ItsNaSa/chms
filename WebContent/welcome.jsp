	...
	<div class="container">
		...
		<div class="row align-items-center py-5">
			...
			<div class="col-lg-5 px-lg-4">
				...
				<a href="fetchdetails.jsp"><button class="btn btn-primary" style="text-align:center"> Fetch patient history  </button></a>
				
				<br>
				<br>
				<a href="viewreport.jsp"><button class="btn btn-primary " style="text-align:center;">  View Date-wise Report</button></a>
				<br>
				<br>
				<a href="ViewMedicinesServlet"><button class="btn btn-primary " style="text-align:center;">  View medicines</button></a>            
