	...
	<div class="container">
		...
		<div class="  card">                  
			<div class="card-header">                  
				<h6 class="text-uppercase mb-0">Medicines List</h6>                       
			</div>					  										                 
			<div class="card-body">       
				<a href="addmedicine.jsp"><button class="btn btn-primary">Add medicine</button></a> 
				<br><br>               
				<table class="table table-striped table-hover card-text">
					...
					<tbody>
						<c:forEach var="tempT" items="${M_ROW}">
						<c:url var="updateLink" value="MedicinesControllerServlet">
						<c:param name="command" value="LOAD" />
						<c:param name="medicineID" value="${tempT.medicineID}" />
					</c:url>                                          
					<tr>
						<td>${tempT.medicineID }</td>
						<td>${tempT.basic_drug}</td>
						<td>${tempT.common_name}</td>
						<td> 
							<a href="${updateLink}">
